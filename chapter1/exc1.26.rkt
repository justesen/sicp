...
; Exercise 1.26
; https://mitpress.mit.edu/sites/default/files/sicp/full-text/book/book-Z-H-11.html#%_thm_1.26
;
...
; Instead of (expmod b 2n m) taking one more call than (expmod b n m), now it
; takes twice as long, hence, Θ(n) instead of Θ(logn).
