...
; have to define your own print procedure for queues.” Explain what Eva Lu is
; talking about. In particular, show why Ben’s examples produce the printed
; results that they do. Define a procedure print-queue that takes a queue as
; input and prints the sequence of items in the queue.

; That the final b is there in the end is just an artefact of how we
; implemented queues. A queue is defined to be empty if the front-ptr is empty
; (which it is here).

; To display something that's more to Ben's tastes, we just only display the
; front-ptr.
