...
; written, the knowledge of the currency is distributed partly into the
...
(= (cc 100 uk-coins) (cc 100 (reverse uk-coins)))

; The order doesn't affect the answer. This could be seen when drawing the tree
; in exercise 1.14.
